...
const AnimatedSVG = () => {
  ...
  const circleAnimations = {
    c1: { 
      initial: { cx: 568.5, cy: 204.5, r: 6 }, 
      outward: { cx: 620, cy: 150, r: 8 } 
    },
    c2: { 
      initial: { cx: 548.5, cy: 184.5, r: 8.5 }, 
      outward: { cx: 590, cy: 120, r: 10 } 
    },
    c3: { 
      initial: { cx: 758.5, cy: 344.5, r: 6 }, 
      outward: { cx: 840, cy: 300, r: 8 } 
    },
    c4: { 
      initial: { cx: 788.5, cy: 344.5, r: 8.5 }, 
      outward: { cx: 870, cy: 320, r: 10 } 
    },
    c5: { 
      initial: { cx: 738.5, cy: 324.5, r: 6 }, 
      outward: { cx: 810, cy: 270, r: 8 } 
    },
  };
  ...
  // Animation variants for vertical "No" nod (g4)
  const verticalNod = {
    initial: { y: 0 },
    animate: {
    ...
    >
        ...
        <mask id="pathMask">
          <motion.g
            ...
            transition={{
              times: [0, 0.6, 0.7, 1],
              duration: 1.4,
              ease: [0.34, 1.76, 0.34, 1]
            }}
            style={{ transformOrigin: '517px 417px' }}
          >
      ...
      <motion.g 
          ...
          >
            <path 
              id="4" 
              d="M290.738 452.232L170.547 412.335C161.895 409.463 152.557 414.393 150.494 423.273C120.82 551.016 165.93 682.579 260.733 767.313C267.554 773.41 278.067 772.038 283.475 764.657L357.769 663.264C362.533 656.761 361.664 647.772 356.193 641.85C313.872 596.035 293.068 532.753 301.847 470.91C302.996 462.815 298.498 454.808 290.738 452.232Z" 
              fill="#B6B8BA"
            />
            <path 
              d="M241.2 590.84C240.5 589.66 238.75 589.66 238.05 590.84L231.39 602.13C230.7 603.3 231.57 604.75 232.96 604.75H246.29C247.68 604.75 248.55 603.3 247.86 602.13L241.2 590.84Z" 
              fill="#9A9EA2"
            />
            <path 
              fillRule="evenodd" 
              clipRule="evenodd" 
              d="M218.42 573.97H223.31V564.5C223.31 555.78 230.61 548.71 239.62 548.71C248.63 548.71 255.93 555.78 255.93 564.5V573.97H260.82C263.52 573.97 265.71 576.09 265.71 578.71V621.34H218.41C215.71 621.34 213.52 619.22 213.52 616.6V578.71C213.52 576.09 215.71 573.97 218.41 573.97H218.42ZM239.63 555.02C234.23 555.02 229.84 559.26 229.84 564.49V573.96H249.41V564.49C249.41 559.26 245.03 555.02 239.62 555.02H239.63ZM220.05 580.28V615.01H259.19V580.28H220.05Z" 
              fill="#9A9EA2"
            />
          </motion.g>
          ...
          >
            <path 
              id="3" 
              d="M389.75 684.817L315.551 787.443C310.21 794.831 312.103 805.219 319.951 809.857C432.854 876.579 571.893 873.128 681.217 808.201C689.083 803.529 690.937 793.09 685.525 785.713L611.172 684.363C606.404 677.863 597.569 675.989 590.276 679.424C533.853 706.006 467.244 706.813 410.905 679.841C403.531 676.31 394.541 678.191 389.75 684.817Z" 
              fill="#B6B8BA"
            />
            <path 
              d="M500.68 784.13C499.98 782.95 498.23 782.95 497.53 784.13L490.87 795.42C490.18 796.59 491.05 798.04 492.44 798.04H505.77C507.16 798.04 508.03 796.59 507.34 795.42L500.68 784.13Z" 
              fill="#9A9EA2"
            />
            <path 
              fillRule="evenodd" 
              clipRule="evenodd" 
              d="M477.9 767.26H482.79V757.79C482.79 749.07 490.09 742 499.1 742C508.11 742 515.41 749.07 515.41 757.79V767.26H520.3C523 767.26 525.19 769.38 525.19 772V814.63H477.89C475.19 814.63 473 812.51 473 809.89V772C473 769.38 475.19 767.26 477.89 767.26H477.9ZM499.11 748.31C493.71 748.31 489.32 752.55 489.32 757.78V767.25H508.89V757.78C508.89 752.55 504.51 748.31 499.1 748.31H499.11ZM479.53 773.57V808.3H518.67V773.57H479.53Z" 
              fill="#9A9EA2"
            />
          </motion.g>
      ...
      {/* Path #1 - scaled up then back with spring (using two separate animations) */}
      <motion.path
        id="1"
      ...
      {/* Fade path - scaled and faded from bottom-left */}
      <motion.path
        id="fade"
